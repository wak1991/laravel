                ...
                <tr>
                    ...
                    <td class="text-right">
                        <form onsubmit="if(confirm('Удалить?')){ return true }else { return false }" action="{{route('admin.user_managment.user.destroy', $user)}}" method="post">
                            ...
                            <a class="btn btn-default" href="{{route('admin.user_managment.user.edit', $user)}}"><i class="fa fa-edit">редактировать</i></a>

                            <button type="submit" class="btn"><i class="fa fa-trash-o">удалить</i></button>
                        </form>
                    </td>
                </tr>
            @empty
